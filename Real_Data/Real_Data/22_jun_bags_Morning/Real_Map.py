...
def create_particles(M):
    ...
    particles[int(0.3*M):int(0.65*M), 0] = uniform(1.65, 16, size = int(0.35*M))
    particles[int(0.3*M):int(0.65*M), 1] = uniform(0, 1.65, size = int(0.35*M))
    particles[int(0.65*M):int(0.95*M), 0] = uniform(3.11, 6.39, size = int(0.3*M))
    particles[int(0.65*M):int(0.95*M), 1] = uniform(1.65, 7.58, size = int(0.3*M))
