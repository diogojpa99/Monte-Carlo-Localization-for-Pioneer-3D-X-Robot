...
def create_particles(M):
    ...
    particles[0:int(0.4*M), 0] = uniform(0, 1.65, size = int(M*0.4))
    particles[0:int(0.4*M), 1] = uniform(0, 16, size = int(0.4*M))
    particles[int(0.4*M):int(0.8*M), 0] = uniform(1.65, 16, size = int(0.4*M))
    particles[int(0.4*M):int(0.8*M), 1] = uniform(0, 1.65, size = int(0.4*M))
    particles[int(0.8*M):M, 0] = uniform(3.11, 6.39, size = int(0.2*M))
    particles[int(0.8*M):M, 1] = uniform(1.65, 8.91, size = int(0.2*M))
