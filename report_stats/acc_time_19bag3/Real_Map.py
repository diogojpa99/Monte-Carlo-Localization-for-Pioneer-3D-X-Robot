...
def create_particles(M):
    ...
    particles[int(0.6*M):int(0.9*M), 0] = uniform(3.11, 6.39, size = int(0.3*M))
    particles[int(0.6*M):int(0.9*M), 1] = uniform(1.65, 7.58, size = int(0.3*M))
